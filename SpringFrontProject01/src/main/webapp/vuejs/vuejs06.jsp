			...
			<table class="table">
				<tr>
					<td class="text-center">
						<button class="btn btn-sm btn-danger" v-on:click="selectMovie(1, '일일 박스오피스')">일일 박스오피스</button>
			...
			<table class="table">
				<thead>
					<tr class="danger">
						...
						<th class="text-center"width="45%">영화명</th>
						<th class="text-center"width="20%">감독</th>
						<th class="text-center"width="20%">장르</th>
					</tr>
				</thead>
				<tbody>
	...
	<script>
		new Vue({
			...
			mounted:function(){
				...
				// function 안에는 this가 없다 => 사용하려면 let으로 변수지정을 해야함
