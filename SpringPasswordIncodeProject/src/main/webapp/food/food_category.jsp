	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="text-center">
				<button class="btn btn-sm btn-danger" @click="categoryGetData(1)">믿고보는 맛집리스트</button>
				<button class="btn btn-sm btn-info" @click="categoryGetData(2)">지역별 맛집리스트</button>
				<button class="btn btn-sm btn-success" @click="categoryGetData(3)">메뉴별 맛집리스트</button>
			</div>
		</div>
