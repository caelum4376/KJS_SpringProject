	...
	<div class="container">
		...
		<div class="row">
			<div class="text-center">
				...
				<b-button variant="outline-dark" @click="musicGetData(6)">JAZZ</b-button>
				<b-button variant="outline-secondary" @click="musicGetData(7)">CLASSIC</b-button>
			</div>
		</div>
		<div style="height: 20px;"></div>
		<div class="row">
			<input type="text" ref="fd" class="input-sm" size="25" placeholder="검색어 입력" 
