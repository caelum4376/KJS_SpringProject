				...
				<table class="table">
					<tr><td>
						<table class="table" v-for="vo in food_list">
							<tr>
								<td width="30%" class="text-center" rowspan="4"><a :href="'../food/food_detail.do?fno='+vo.fno">
									<img :src="vo.poster" style="width: 100%; height:250px;" class="img-rounded">
								</a></td>
								<td width="70%">
									<h4><a :href="'../food/food_detail.do?fno='+vo.fno">{{vo.name}}</a>&nbsp;<span style="color:orange;">{{vo.score}}</span></h4>
								</td>
							</tr>
							<tr>
