  ...
  <main class="container clear"> 
    ...
    <table class="table">
     ...
     <tr>
       ...
       <td class="text-center">
        <img src="../recipe/images/mem4.png">&nbsp;{{chef_info.mem_cont4}}
       </td>
       <td class="text-center">
    ...
    <%-- 
    		...
    		2. template : 컴포넌트 (기능) => 화면에 ㅜㅊㄹ력할 요소(태그)를 작성)
    		...
    		4. 부모의 데이터를 읽을 때
    			Vue.component() => Child
    				...
    				=> this.$parent.변수, 메소드
    			new Vue({}) => Parent
    		5. v-model => 데이터 양방향 => 입력 => 자동으로 변수에 값을 채운다
      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear" v-else>
            <li :class="index%4==0?'one_quarter first':'one_quarter'" v-for="vo, index in recipe_list">
   ...
   new Vue({
	   ...
	   methods:{
		   ...
		   dataRecv:function(){
			   ...
			   // 페이지 정보 읽기
			   axios.get('../recipe/page_info_vue.do',{
				   params:{
					   page:this.curpage,
					   fd:this.fd,
					   chef:this.chef
